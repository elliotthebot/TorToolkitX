...
async def start_handler(event):
    msg = "Hello This is TorToolkitX running on heroku an instance of MirrorX . This Repo</a>. Try the repo for yourself and dont forget to put a STAR and fork."
...
async def booted(client):
    ...
    for i in chats:
        try:
            await client.send_message(i, "The bot is booted and is ready to use..Greetings from @mirrorxy.")
